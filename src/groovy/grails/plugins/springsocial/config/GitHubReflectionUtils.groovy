...
import grails.plugins.springsocial.github.SpringSocialGitHubUtils
 ...
 */
class GitHubReflectionUtils {

    private GitHubReflectionUtils() {
        // static only
    }

    static getConfigProperty(String name) {
        def value = SpringSocialGitHubUtils.config
    ...
    static void setConfigProperty(String name, value) {
        def config = SpringSocialGitHubUtils.config
